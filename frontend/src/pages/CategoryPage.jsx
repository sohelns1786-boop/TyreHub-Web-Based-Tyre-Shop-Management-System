...
const categories = {
  Bike: 'Best bike tyre collection for performance and control.',
  Car: 'Premium car tyres built for safety and comfort.',
  Auto: 'City auto tyres for durability and smooth driving.',
  Lorry: 'Heavy-duty lorry tyres for long haul reliability.',
};
...
export default function CategoryPage() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      setError(null);
      try {
        const response = await api.get('/products', { params: { vehicleType } });
  ...
  const description = categories[vehicleType] || 'Tyre products for your vehicle type.';

  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
      <div className="mb-8 rounded-3xl border border-white/10 bg-white/5 p-8 shadow-xl shadow-black/10">
        <h1 className="text-3xl font-semibold text-white">{vehicleType} Tyres</h1>
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="mt-3 space-y-1 text-sm text-white/70">
                ...
                <p>Vehicle: <span className="text-white font-medium">{tyre.vehicleType || vehicleType}</span></p>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-3 text-white/80">
                    ...
                    <div className="grid grid-cols-[100px_1fr]">
                      ...
                      <span className="font-semibold">{selectedTyre.vehicleType || vehicleType}</span>
                    </div>
                    <div className="grid grid-cols-[100px_1fr]">
